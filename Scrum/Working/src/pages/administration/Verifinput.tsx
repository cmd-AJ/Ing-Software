...
const Inputver: React.FC<ContainerProps> = ({setDpi, validateDpi, setValidateBoolean}) => {
    ...
    return (
        <IonInput 
            fill='solid' 
            placeholder='DPI: XXXX XXXXX XXXX' 
            className={`${'inputins'} ${validateDpi === false && 'ion-invalid'} ${isTouched && 'ion-touched'}`}
            color='dark'
