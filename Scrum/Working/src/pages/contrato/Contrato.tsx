...
const Contrato: React.FC = () => {
  const [hoveredImage, setHoveredImage] = useState<string | null>("https://img.freepik.com/foto-gratis/primer-plano-carpintero-masculino-que-mide-tablon-madera-largo-regla_23-2147945070.jpg?t=st=1730428246~exp=1730431846~hmac=6d2c22cbe30a912f8f2249e2be04384b934c76eccfd289a52c692c9b58440861&w=1380");
  ...
  const cardsData: Card[] = [
    {
      ...
      imageUrl: "https://img.freepik.com/foto-gratis/mujer-trabajando-taller_23-2148836020.jpg?t=st=1730428286~exp=1730431886~hmac=7aeea776419d683454190fce9ed1bc60c1dbbf3c2d41af3bf7f091fe05875b1b&w=2000", // Replace with actual image URLs
    },
    {
      title: "¿Cómo Funciona?",
      content:
              ...
              <div className={styles.cardsContainer}>
                {cardsData.map((card, index) => (
                  <div
                    ...
                    onMouseLeave={() => setHoveredImage("https://img.freepik.com/foto-gratis/primer-plano-carpintero-masculino-que-mide-tablon-madera-largo-regla_23-2147945070.jpg?t=st=1730428246~exp=1730431846~hmac=6d2c22cbe30a912f8f2249e2be04384b934c76eccfd289a52c692c9b58440861&w=1380")}
                  >
                    <h1>{card.title}</h1>
                    <p>{card.content}</p>
                  </div>
